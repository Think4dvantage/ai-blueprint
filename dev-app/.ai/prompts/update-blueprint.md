...
> **Category**: `dev-app` — Flutter mobile apps
...
**URL**: `https://raw.githubusercontent.com/Think4dvantage/ai-blueprint/main/dev-app/.ai/manifest.json`
...
Base URL: `https://raw.githubusercontent.com/Think4dvantage/ai-blueprint/main/dev-app/.ai/`
...
| `instructions/02-app-conventions.md` | `instructions/02-app-conventions.md` |
| `instructions/03-api-client-conventions.md` | `instructions/03-api-client-conventions.md` |
...
Skim updated framework files against project data files. Flag mismatches — do not auto-fix.
...
```markdown
# Contribution from Project: [PROJECT NAME] (dev-app category)

Please update the following blueprint files in dev-app/.ai/:

1. `prompts/new-flutter-prompt.md`: [description]
